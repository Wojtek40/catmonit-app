...
public class StorageViewModel extends ViewModel {
    ...
    public StorageViewModel() {
        ...
        storageState.setValue(new StorageState(1000000009900L,
                564744453000L,
                ...
                new DeviceInfo[] {new DeviceInfo("Sample device", "192.0.0.78", "", new DiscInfo[] {new DiscInfo("/dev/nvme1", 120000L, 3197798L)}),
                                  new DeviceInfo("Sample device", "192.0.0.78", "", new DiscInfo[] {new DiscInfo("/dev/nvme1", 120000L, 3197798L), new DiscInfo("/dev/nvme1", 1200000L, 3197798L)})}
        ));
    }
